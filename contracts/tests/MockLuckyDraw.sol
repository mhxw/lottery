...
contract MockLuckyDraw is Ownable {
  ...
  constructor() {
    ...
    randomnessForFirstPrize = 0xf0ed6ee14c45ebe86c4217a8a4700ba267a8345329954ff95adc6d86724dcb97;
    randomnessForSecondPrize = 0xb6c604d88e207039a13f11270d862a14c943ffb7ca4e88e09a59eab333f74758;
    randomnessForThirdPrize = 0xa31e398148817236d20d9de1f68ee0babd60b6887fdff2fe3a3c990d33814126;
    randomnessForFourthPrize = 0xe2153b3b908f0e73bdd37b1200b4caa807d50ddeeae081ac96178ef779727b35;
  }

  function reset() public {
    thirdIndex = 0;
    fourthIndex = 0;
    drawTimesForThirdPrize = 0;
    drawTimesForFourthPrize = 0;
    requestStatus = 0;
    fetchStatus = 0;
    delete (listForGrandPrize);
    delete (listForFirstPrize);
    delete (listForSecondPrize);
    delete (listForThirdPrize);
    delete (listForFourthPrize);
  }
   ...
   */
  function requestRandomNumber(uint256 prizeType) external payable {
   ...
   * @dev Only callable by owner
   */
  function fetchRandomNumber(uint256 prizeType) external {
    uint256 blockNumber;
    if (prizeType == 1) {
      require(
        fetchStatus == 2,
   ...
   */
  function pickWinner(uint256 prizeType) public {
    if (prizeType == 0) {
